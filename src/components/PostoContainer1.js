...
import "./PostoContainer1.css";
import { useDispatch, useSelector } from "react-redux";
import { ADMIN_POSTO_POSTIM } from "../redux/actions";
import { ADMIN_UPDATE_POSTIM } from "../redux/actions";
...
const PostoContainer = ({
  ...
  const registerFormActive = useSelector(
    (state) => state.activeFormsState.activeForm.AdminNjoftimetActive1
  );
  return (
    <div
