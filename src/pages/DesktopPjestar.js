...
import { GetAntaretAdmin, GetPjesmarresitNjoftim } from "../redux/asyncActions";
import { useEffect } from "react";
import { useParams } from "react-router-dom";
import Component41 from "../components/Component41";

const DesktopPjestar = () => {
  ...
  useEffect(() => {
    dispatch(GetPjesmarresitNjoftim(page));
  }, []);
